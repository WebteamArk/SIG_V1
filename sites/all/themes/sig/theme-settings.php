 ...
 */
function sig_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['sig_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('sig sample setting'),
  '#default_value' => theme_get_setting('sig_example'),
